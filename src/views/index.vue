<template>
  <div class="app-container">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick" type="border-card">
      <el-tab-pane label="当前任务" name="curAssignment">
        <el-table
          v-loading="loading"
          :data="personList"
        ...
        >
          ...
          <el-table-column label="线体" prop="line" width="120" />
          <el-table-column label="区域" prop="area" width="120" />
          <el-table-column label="分组" prop="mygrouping" width="120" />
          ...
          <el-table-column label="分配人" prop="distributee" width="120" />
          <el-table-column label="分配时间" prop="distributetime" width="120" />
          <el-table-column label="截至时间" prop="deadtime" width="120" />
